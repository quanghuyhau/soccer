...
import 'package:soccer/presentation/screens/bookings/cubit/create_booking_cubit.dart';
    ...
    return BlocProvider(
      ...
      child: BlocBuilder<CreateBookingCubit, CreateBookingState>(
        builder: (context, state) {
          final notifier = context.read<CreateBookingCubit>();
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        _field(notifier.dateController, 'Ngày', Icons.today),
                        _SlotPicker(
                          slots: slots,
