...
Future<void> confirmDeleteVenue(BuildContext context, Venue venue) async {
  ...
  if (confirmed == true && context.mounted) {
    context.read<VenueMutationCubit>().delete(venue.id);
  }
}
...
class _VenueDialogState extends State<_VenueDialog> {
  ...
  Widget build(BuildContext context) {
    final state = context.watch<VenueMutationCubit>().state;
  ...
  void _submit() {
    ...
    final controller = context.read<VenueMutationCubit>();
    final venue = widget.venue;
